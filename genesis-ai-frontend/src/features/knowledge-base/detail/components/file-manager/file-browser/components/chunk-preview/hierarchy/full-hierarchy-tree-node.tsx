...
import { ParentChainNode } from './parent-chain-node'

// ============================================================
// FullHierarchyTreeNode - 全屏树节点（可展开/折叠）
// ============================================================

interface FullHierarchyTreeNodeProps {
  nodeId: string
  initialData?: Chunk
  ...
  isRoot?: boolean
  depth?: number
  initialChunkId?: string | null // 初始打开的节点 ID
}

export function FullHierarchyTreeNode({
  nodeId,
  initialData,
  selectedNodeId,
  expandedNodes,
  ...
  const isInitialNode = nodeId === initialChunkId // 是否是初始打开的节点
  ...
  return (
    <div className='relative'>
      ...
      {/* 如果是根节点且有父节点，显示向上溯源 */}
      {isRoot && hasParent && (
        <div className='mt-4 border-t-2 border-dashed border-amber-200 pt-4 dark:border-amber-900'>
          <div className='mb-3 flex items-center gap-2 rounded-lg border border-amber-200 bg-amber-50 px-2 py-1.5 dark:border-amber-800 dark:bg-amber-950/30'>
